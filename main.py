...
def auto_transmission(params: Dict[str, Any]) -> Simulator:
...
def auto_transmission3(params: Dict[str, Any]) -> Simulator:
...
def auto_transmission4(params: Dict[str, Any]) -> Simulator:
...
def auto_transmission5(params: Dict[str, Any]) -> Simulator:
...
def auto_transmission6(params: Dict[str, Any]) -> Simulator:
...
def auto_transmission7(params: Dict[str, Any]) -> Simulator:
...
def set_logger(simulator_name: str = None) -> None:
    """
    Log to file in a repository log.
    ...
    filehandler = logging.FileHandler(f'log/{now}-{simulator_name}.log', 'a')
...
def empirical_precision(simulator_name: str, 
                        ...
                        params: Dict[str, Any] = {}):
    """
    A function apart from the algorithm. 
